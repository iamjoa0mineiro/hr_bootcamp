...
X_resampledt = X_test_final_keep 
y_resampledt = y_test
...
X_numerical_scaled_dft = pd.DataFrame(X_numerical_scaledt, columns=numerical_features, index=X_numericalt.index)  # Convert to DataFrame
